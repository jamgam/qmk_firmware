...
//    └───────────────┴───┼──────┼──────┼──────┼───────────────┼─────┤   ├───────────────┼────────────────┼─────┼──────┼────┼───┴──────┘
//                        │ left │ rght │ lalt │ OSM(MOD_LSFT) │ MOD │   │ LT(_NUM, ent) │ LT(_SYM, bspc) │ spc │ down │ up │
//                        └──────┴──────┴──────┴───────────────┴─────┘   └───────────────┴────────────────┴─────┴──────┴────┘
[_BASE] = LAYOUT(
  KC_TAB           , KC_Q , KC_W    , KC_F     , KC_P    , KC_B          , KC_TRNS ,     KC_TRNS          , KC_J              , KC_L   , KC_U    , KC_Y   , KC_SCLN , KC_BSLS,
  LT(_NUM, KC_ESC) , KC_A , KC_R    , KC_S     , KC_T    , KC_G          , KC_TRNS ,     KC_TRNS          , KC_M              , KC_N   , KC_E    , KC_I   , KC_O    , KC_QUOT,
  KC_RCTL          , KC_Z , KC_X    , KC_C     , KC_D    , KC_V          , KC_TRNS ,     KC_TRNS          , KC_K              , KC_H   , KC_COMM , KC_DOT , KC_SLSH , KC_LGUI,
                            KC_LEFT , KC_RIGHT , KC_LALT , OSM(MOD_LSFT) , MOD     ,     LT(_NUM, KC_ENT) , LT(_SYM, KC_BSPC) , KC_SPC , KC_DOWN , KC_UP
),
...
//                  └───────────┴───────────┴─────┴─────┴─────┘   └─────┴──────┴──────┴────┴─────┘
[_SYM] = LAYOUT(
  KC_VOLU      , KC_LCBR , KC_LPRN   , KC_RPRN   , KC_RCBR , KC_INS  , KC_TRNS ,     KC_TRNS , KC_PGUP , KC_TILDE , KC_UNDS , KC_GRV  , KC_COLN , KC_MUTE,
  KC_VOLD      , KC_EXLM , KC_AT     , KC_HASH   , KC_DLR  , KC_PERC , KC_TRNS ,     KC_TRNS , KC_CIRC , KC_AMPR  , KC_ASTR , KC_EQL  , KC_MINS , KC_DQUO,
  LGUI(KC_GRV) , KC_LT   , KC_LBRC   , KC_RBRC   , KC_GT   , KC_DEL  , KC_TRNS ,     KC_TRNS , KC_PGDN , KC_BSLS  , KC_PIPE , KC_PLUS , KC_QUES , QK_BOOT,
                           PREV_WORD , NEXT_WORD , KC_TRNS , KC_TRNS , KC_TRNS ,     KC_TRNS , KC_TRNS , KC_DOWN  , KC_UP   , KC_TRNS
),
...
//                └─────┴─────┴─────┴─────────┴─────┘   └─────┴─────┴─────┴───┴───┘
[_NUM] = LAYOUT(
  KC_TRNS , KC_F12 , KC_F7   , KC_F8   , KC_F9   , EE_CLR  , KC_TRNS ,     KC_TRNS , KC_TRNS , KC_7    , KC_8 , KC_9   , KC_ASTR , KC_SLASH,
  KC_TRNS , KC_F11 , KC_F4   , KC_F5   , KC_F6   , KC_TRNS , KC_TRNS ,     KC_TRNS , KC_TRNS , KC_4    , KC_5 , KC_6   , KC_MINS , KC_TRNS ,
  KC_TRNS , KC_F10 , KC_F1   , KC_F2   , KC_F3   , QK_BOOT , KC_TRNS ,     KC_TRNS , KC_0    , KC_1    , KC_2 , KC_3   , KC_PLUS , KC_COMMA,
